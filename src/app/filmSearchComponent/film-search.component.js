...
var film_search_service_1 = require("../filmSearchService/film-search.service");
var FilmSearchComponent = (function () {
    function FilmSearchComponent(filmSearchService, router) {
    ...
    FilmSearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.films = this.searchTerms
            .debounceTime(300) // wait 300ms after each keystroke before considering the term
            .distinctUntilChanged() // ignore if next search term is same as previous
            .switchMap(function (term) { return term // switch to new observable each time the term changes
            ? _this.filmSearchService.search(term)
...
FilmSearchComponent = __decorate([
    core_1.Component({
        ...
        providers: [film_search_service_1.FilmSearchService]
    }),
    __metadata("design:paramtypes", [film_search_service_1.FilmSearchService,
        router_1.Router])
], FilmSearchComponent);
